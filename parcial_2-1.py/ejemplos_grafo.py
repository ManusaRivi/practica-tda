...
grafo0 = Grafo(False, [1, 2, 3])

grafo0.agregar_arista(1, 2)
grafo0.agregar_arista(1, 3)

grafo1 = Grafo(False, [1, 2, 3, 4])
...
grafo2 = Grafo(False, [i for i in range(1, 8)])
...
grafo3 = Grafo(False, [i for i in range(1, 11)])
...
grafo4 = Grafo(False, [1, 2, 3, 4, 5])

grafo4.agregar_arista(1, 2)
grafo4.agregar_arista(1, 3)
grafo4.agregar_arista(1, 4)
grafo4.agregar_arista(2, 5)
grafo4.agregar_arista(3, 5)
grafo4.agregar_arista(4, 5)
